...
class system(object):
    ...
    def __init__(self,L=6,d=2,T=3,
        ...
        self.nearest_neighbours = self.l.neighbour_sites[0]
...
#                #print(self.sites[isite])
            ...
            if dE > 0:
                if np.exp(-dE/self.T) < ranp:
                    ...
                    #for isite in isites:
                        #print(self.sites[isite])
                    self.sites[isites] = sites0[isites]
                        #print(self.sites[isite])
            #print(self.sites[isite])
            #print(dE)
            #for isite in isites:
    ...
    def energy(self):
        ...
        return -self.orderp[0]*sum(self.sites) + (
                        sum(-self.orderp[r]/2 
                            *sum(sum(
                                     n*self.sites[j] 
...
class Lattice(object):
    ...
    def __init__(self,L=6,d=2):
        ...
        # L^i for i = 1:d array
        self.L_i = np.power(self.L,np.arange(self.d,dtype='int64'))
    ...
    def neighboursites(self,site=None,r=1):
        ...
        if r==None:
            Rrange = range(1,int(np.ceil(self.L/2)))
